...
import {
  ScrollView, StyleProp, StyleSheet, Vibration, View, ViewStyle
} from 'react-native';
...
export const QuestionContainer: React.FunctionComponent<Props> = (props) => {
  ...
  const [userAnswer, setUserAnswer] = useState<UserAnswerSubmit | undefined>();
  ...
  return (
      <View style={[{ paddingVertical: Dimens.spaces.screen }, styles.container, themeStyle.styles.backgroundColor, props.style]}>  
          <QuestionView
            question={question}
        ...
        {explanation?.correct === false && (
          <Animatable.View ref={animatableViewRef} useNativeDriver={true}>
